                        ...
                        <div class="z-10">
                            ...
                            <div class="grid sm:grid-cols-1 md:grid-cols-2 mx-auto justify-center mt-12 gap-4">
                                ...
                                <div class="beep text-center relative hover:scale-95 cursor-pointer">
                                    <a href="{{ url('/') }}" class="mt-2 absolute inset-0 flex items-center justify-center text-white text-4xl">                                    <img class="h-16 md:h-24 w-full" src="{{ asset('website/images/button.svg') }}">
