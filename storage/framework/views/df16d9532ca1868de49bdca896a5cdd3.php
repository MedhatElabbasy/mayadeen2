            ...
            <div class="flex justify-between mt-12">
                <div>
                    <a href="<?php echo e(url('/writers/'.$writer->id.'/works')); ?>" wire:navigate class="flex gap-2 justify-center items-start">
                        ...
                        <img src="<?php echo e(asset('website/images/arrow-right.svg')); ?>" class="w-6">
                    </a>
                </div>

                <div>
                    <a href="<?php echo e(url('/writers/'.$writer->id)); ?>" wire:navigate class="flex gap-2 justify-center items-start">
                        <img src="<?php echo e(asset('website/images/arrow-left.png')); ?>" class="w-6">
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/bd8114bed15494bc0dbd7628c5829989.blade.php ENDPATH**/ ?>