        ...
        <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34] mb-4">
            ...
            <div>
                <div x-show="step == 1" class="px-8 border-x-2 border-[#e34e34]">
                    ...
                    <div class="text-center text-[#e34e34] p-4" style="line-height:normal">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/283e379945caa7d42f803365022713ef.blade.php ENDPATH**/ ?>