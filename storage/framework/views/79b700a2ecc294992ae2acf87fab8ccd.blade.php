...
?>
        ...
        <div id="app" x-data="{ step: 10 }" class="border-x-2 border-[#e34e34]">
            ...
            <div x-show="step==10">
                ...
                |---LINE:557---|@endphp
                <div x-data="{
                    |---LINE:559---|@foreach ($rating_list['screen1'] as $rating)
                    ...
                    <form wire:submit="submit">
                        <div class="z-10 p-2" x-data="{ ratingStep: 1 }">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                |---LINE:574---|@foreach($rating_list as $rating)
                                    <div>
...
|---LINE:597---|{{--
                                <div class="max-w-sm mx-auto">
                                    ...
                                    |---LINE:602---|@error('opinion')
                                        <div class="text-white">ادخل رأيك*</div>
                                    |---LINE:604---|@enderror
                                </div> --}}
                            </div>

                            |---LINE:608---|{{-- <div class="beep text-center relative hover:scale-95 mt-4 rounded-lg">
                ...
                <div class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                    <div class="z-10">
                        ...
                        <div class="beep text-center relative hover:scale-95 mb-8">
                            <a href="|---LINE:626---|{{ url('/surveys') }}" wire:navigate>
                                <img class="h-16 md:h-24 w-full" src="|---LINE:627---|{{ asset('website/images/button.svg') }}"
                                    alt="">
                                <span
