            ...
            <div>
                <div x-show="step == 1" class="px-8 border-x-2 border-[#e34e34]">
                    ...
                    <div class="text-center p-4" style="line-height:normal">
                        <h1 class="text-center text-2xl font-bold my-8 text-[#e34e34]">الشروط</h1>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/19cf86bb2c70ae3e2a907268f72f87d8.blade.php ENDPATH**/ ?>