    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col md:flex-row justify-center text-center items-center md:justify-between">
                <img src="<?php echo e(asset('website/images/sound-play.svg')); ?>" class="w-14 md:w-12">
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/efbd1f198a653341c3c12620ef5e386a.blade.php ENDPATH**/ ?>