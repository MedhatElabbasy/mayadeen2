...
?>
                ...
                <div x-data="{ currentDate: 0 }">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div x-data="{
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(!$item->is_break): ?>
                            <p class="mt-4 text-center font-normal text-sm">
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/f45027c99a7bbffa26c33095fe7cea85.blade.php ENDPATH**/ ?>