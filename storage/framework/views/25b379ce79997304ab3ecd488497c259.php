    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <audio controls class="mb-4 bg-gray-100 rounded-lg">
...
Calamansi.autoload();
    ...
    ?>
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/4e75dce0b3cbfa8d0f9d4ab47e814788.blade.php ENDPATH**/ ?>