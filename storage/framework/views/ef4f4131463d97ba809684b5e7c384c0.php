...
<div id="app">
    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                <img src="<?php echo e(asset("storage/".$this->writer->qr)); ?>" class="h-20 w-20 rounded-lg">
            </div>
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/664db7db1eabc421cd55a67fb5e0ffc8.blade.php ENDPATH**/ ?>