    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col md:flex-row md:justify-between" x-date="{ audio: 'hassan' }">
                <img x-show="audio==='hassan'" src="{{ asset('website/images/sound-play.svg') }}" class="w-14 cursor-pointer">
                <img x-show="audio==='hassan'" src="{{ asset('website/images/sound-stop.svg') }}" class="w-14 cursor-pointer">
