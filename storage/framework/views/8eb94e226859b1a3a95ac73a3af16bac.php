            ...
            <div x-show="step==10">
                ...
                <div x-data="{
                    ...
                    <div x-data="{rating_screen: 1}">
                        <div class="z-10 p-2">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col items-center justify-center gap-2">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/2a486b3ba7edce2e264dc0617c171a38.blade.php ENDPATH**/ ?>