                    ...
                    <form wire:submit="submit">
                        <div class="z-10 p-2">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                |---LINE:574---|@dd($rating_list['screen1'])
                                |---LINE:575---|@foreach($rating_list['screen1'] as $rating)
                                    <div class="max-w-sm mx-auto w-full">
                                        <label for="rating"
                                            class="block mb-2 font-medium text-[#f1e1c6] rounded-lg">|---LINE:578---|{{$rating}}</label>
                                        <div class="flex items-center text-center">
                                            |---LINE:580---|@foreach ([1, 2, 3, 4, 5] as $value)
                                                <div class="contents cursor-pointer scale-90 text-gray-300">
                                                    <svg
                                                        wire:click="updateRating('|---LINE:583---|{{Str::slug($rating, '_')."',".$value}})"
                                                        x-on:click="|---LINE:584---|{{Str::slug($rating, '_')}}=|---LINE:584---|{{$value}}"
                                                        :class="{ 'text-yellow-300': |---LINE:585---|{{Str::slug($rating, '_')}} >= |---LINE:585---|{{$value}} }"
                            ...
                            <div class="beep text-center relative hover:scale-95 mt-4 rounded-lg">
                                <img class="h-16 md:h-24 w-full" src="|---LINE:608---|{{ asset('website/images/button.svg') }}"
                                    alt="">
                                <button type="submit"
                ...
                <div class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                    <div class="z-10">
                        ...
                        <div class="beep text-center relative hover:scale-95 mb-8">
                            <a href="|---LINE:625---|{{ url('/surveys') }}" wire:navigate>
                                <img class="h-16 md:h-24 w-full" src="|---LINE:626---|{{ asset('website/images/button.svg') }}"
                                    alt="">
                                <span
