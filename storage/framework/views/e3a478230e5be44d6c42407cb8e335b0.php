    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <audio controls class="mb-4 bg-gray-100 px-4 py-2 rounded-full">
...
Calamansi.autoload();
    ...
    ?>
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/1df014226e87490f6546f67f1e5909ea.blade.php ENDPATH**/ ?>