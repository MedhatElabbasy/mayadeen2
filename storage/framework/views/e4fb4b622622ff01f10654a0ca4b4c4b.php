...
?>
                    ...
                    <form wire:submit="submit">
                        <div class="z-10 p-2">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rating_list['screen1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="max-w-sm mx-auto w-full">
                                        <label for="rating"
                                            class="block mb-2 font-medium text-[#f1e1c6] rounded-lg"><?php echo e($rating); ?></label>
                                        <div class="flex items-center text-center w-screen md:w-80">
                                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [1, 2, 3, 4, 5]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="contents cursor-pointer scale-90 text-gray-300 w-full">
                                                    <svg
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/b25262777d9d144fa8881e4c90b59d2e.blade.php ENDPATH**/ ?>