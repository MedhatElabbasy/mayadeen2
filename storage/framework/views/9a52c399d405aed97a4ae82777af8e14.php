...
?>
    ...
    ?>
        <script>
            ...
            const input = document.querySelector("#phone3");
            window.intlTelInput(input, {
                initialCountry: "auto",
                geoIpLookup: callback => {
                    fetch("https://ipapi.co/json")
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/7bfa53aa1f9313eddcb34c18549a54f1.blade.php ENDPATH**/ ?>