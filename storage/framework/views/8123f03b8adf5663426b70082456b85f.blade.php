...
<div id="app">
    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="essential_audio" data-url="{{ asset("storage/".$this->writer->podcast) }}"></div>
            ...
            <div class="flex justify-between mt-12">
                <div>
                    <a wire:ignore href="{{ url('/writers/'.$writer->id.'/quote') }}" wire:navigate class="flex gap-2 justify-center items-start">
