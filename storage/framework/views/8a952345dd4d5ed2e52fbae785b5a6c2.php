...
?>
        ...
        <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34] min-h-screen">
            ...
            <div x-show="step==2" class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                <div class="z-10">
                    <h1 class="text-center text-3xl mt-16 font-bold my-8 text-[#e34e34]" style="line-height:normal">
                    ...
                    <ul class="grid w-full grid-cols-4 text-center">
                            ...
                            <label for="experience_radio1" wire:click="updateExperience('verySatisfied')" x-on:click="step++">
                                <div class="text-center relative mt-16">
                                    <div class="flex flex-col gap-2 items-center justify-center cursor-pointer">
                                        <img src="<?php echo e(asset('website/images/rating/1.svg')); ?>" class="drop-shadow-sm">
                        ...
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            ...
                            <label for="experience_radio2" wire:click="updateExperience('satisfied')" x-on:click="step++">
                                <div class="text-center relative mt-16">
                                    <div class="flex flex-col gap-2 items-center justify-center cursor-pointer">
                                        <img src="<?php echo e(asset('website/images/rating/2.svg')); ?>" class="drop-shadow-sm">
                        ...
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            ...
                            <label for="experience_radio" wire:click="updateExperience('neutral')" x-on:click="step++">
                                <div class="text-center relative mt-16">
                                    <div class="flex flex-col gap-2 items-center justify-center cursor-pointer">
                                        <img src="<?php echo e(asset('website/images/rating/3.svg')); ?>" class="drop-shadow-sm">
                        ...
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            ...
                            <label for="experience_radio" wire:click="updateExperience('upset')" x-on:click="step++">
                                <div class="text-center relative mt-16">
                                    <div class="flex flex-col gap-2 items-center justify-center cursor-pointer">
                                        <img src="<?php echo e(asset('website/images/rating/4.svg')); ?>" class="drop-shadow-sm">
            ...
            <div x-show="step==10">
                ...
                ?>
                <div x-data="{
                    <?php $__currentLoopData = $rating_full_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php echo e(Str::slug($rating, '_').':3,'); ?>
                    ...
                    <div x-data="{rating_screen: 1}">
                        <div class="z-10 p-2">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rating_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div x-show="rating_screen==<?php echo e($loop->index+1); ?>" class="animate__animated animate__backInDown">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rating_list["screen".$loop->index+1]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div>
                                                <label for="rating"
                                                    class="block font-medium text-[#f1e1c6] rounded-lg"><?php echo e($rating); ?></label>
                                                <div class="flex items-center text-center w-full ">
                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = [1, 2, 3, 4, 5]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="contents cursor-pointer text-gray-300">
                                                            <div class="w-12 md:w-full">
                                                                <svg
                                                                    wire:click="updateRating('<?php echo e(Str::slug($rating, '_')."',".$value); ?>)"
                                                                    x-on:click="<?php echo e(Str::slug($rating, '_')); ?>=<?php echo e($value); ?>"
                                                                    :class="{ 'text-yellow-300': <?php echo e(Str::slug($rating, '_')); ?> >= <?php echo e($value); ?> }"
                             ...
                             <div class="beep text-center relative hover:scale-95 mt-4 rounded-lg">
                                <img class="h-16 md:h-24 w-full" src="<?php echo e(asset('website/images/button.svg')); ?>"
                                    alt="">
                                <button
                                    x-on:click="rating_screen < <?php echo e($rating_screens); ?> ? rating_screen++ : step++"
                                    type="button"
                        ...
                        <div class="z-10 p-2" x-data="{ ratingStep: 1 }">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                <div class="max-w-sm mx-auto">
                                    ...
                                    <textarea rows="5" required min="2" class="bg-[#f1e1c6] p-2.5 text-black rounded-lg" wire:model="opinion"
                                        placeholder="أكتب لنا رأيك"></textarea>
                                    <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['opinion'];
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                    <div class="z-10">
                        ...
                        <div class="beep text-center relative hover:scale-95 mb-8">
                            <a href="<?php echo e(url('/surveys')); ?>" wire:navigate>
                                <img class="h-16 md:h-24 w-full" src="<?php echo e(asset('website/images/button.svg')); ?>"
                                    alt="">
                                <span
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/c5140bd20a9eca4c56acd7146f3579f9.blade.php ENDPATH**/ ?>