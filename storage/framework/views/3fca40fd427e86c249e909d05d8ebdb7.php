...
?>
                    ...
                    <form wire:submit="submit">
                        ...
                        <div class="z-10 p-2">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2" x-data="{rating_screen: 1}">
                                    <div x-show="rating_screen==<?php echo e($loop->index++); ?>">
                                            <div>
                                                <label for="rating"
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/30d73b0de87123ce0341514d0314cefe.blade.php ENDPATH**/ ?>