...
<div id="app">
    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                <img src="<?php echo e(asset("storage/".$this->writer->qr)); ?>" class="h-22 w-22 rounded-lg">
            </div>
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/e8f05d77c286861e59fc070806cebe56.blade.php ENDPATH**/ ?>