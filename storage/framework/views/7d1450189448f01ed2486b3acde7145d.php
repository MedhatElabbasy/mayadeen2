...
?>
        ...
        <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34]">
            ...
            <div x-show="step==2" class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                <div class="z-10">
                    <h1 class="text-center text-3xl mt-16 font-bold my-8 text-[#e34e34]">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/fe72b67e645715ba146e5989fd4d2bb1.blade.php ENDPATH**/ ?>