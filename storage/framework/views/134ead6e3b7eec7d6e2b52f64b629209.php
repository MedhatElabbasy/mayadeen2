            ...
            <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34]">
               ...
               <!-- Banner -->
                ...
                <div class="z-10 p-2" x-data="{ name: '' }">
                    <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                        <div class="w-full">
                            ...
                            <input required min="2" type="text" class="w-full bg-[#f1e1c6] p-4 text-black rounded-lg"
                                x-model="title" wire:model="title" placeholder="أدخل إسم القصيدة">
                                <div x-show="title.length < 2" class="text-white mt-2">يجب ان يحتوي الإسم علي حرفين علي الأقل*
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    x-on:click="if(title.length >= 2) step++">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/6411fbbc8d670d8443425b4bda7ceaa1.blade.php ENDPATH**/ ?>