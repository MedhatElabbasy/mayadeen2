...
?>
               ...
               <!-- Banner -->
                            ...
                            <div class="z-10 p-2">
                                <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                    ...
                                    <div class="max-w-sm mx-auto" wire:ignore>
                                        <label for="phone" class="block mb-2 font-medium text-[#f1e1c6]">الهاتف</label>
                                        <input wire:ignore required min="9" type="tel"
                                        class="bg-[#f1e1c6] w-80 p-2.5 rounded-lg text-black phone" wire:model="w3_number"
                                        x-model="number"
                                        placeholder="أدخل الهاتف">
                                            <div x-show="number.length < 9" class="text-white">ادخل الهاتف*</div>
                                    </div>
                        ...
                        <div class="z-10">
                            ...
                            <div class="grid sm:grid-cols-1 md:grid-cols-2 mx-auto justify-center mt-12 gap-4">
                                ...
                                <div class="beep text-center relative hover:scale-95 cursor-pointer">
                                    <a href="<?php echo e(url('/')); ?>" class="mt-2 absolute inset-0 flex items-center justify-center text-white text-4xl">                                    <img class="h-16 md:h-24 w-full" src="<?php echo e(asset('website/images/button.svg')); ?>">
                ...
                #########
                    <div class="flex flex-col items-center justify-center my-36 animate__animated animate__bounce">
                        <div class="z-10">
                            <h1 class="text-center text-4xl mt-16">تم انشاء الأقصوصة</h1>
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/8cd5b3eb78e07d5caae6fc59b85b5b55.blade.php ENDPATH**/ ?>