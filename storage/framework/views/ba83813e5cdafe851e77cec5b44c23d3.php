...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($this->image): ?>
                                        <div class="mt-4 rounded-lg" id="imagePreviewContainer">
                                            <div class="text-gray-700">الملف: <?php echo e($this->image?->getClientOriginalName()); ?></div>
                                        </div>
                    ...
                    <div class="container mx-auto px-4 justify">
                        <div class="z-10">
                            ...
                            <div class="beep text-center relative hover:scale-95 mb-8">
                                <a href="<?php echo e(url('/visitors/vip')); ?>" wire:navigate>
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/f78a33abfe029d84e29ddede43e168af.blade.php ENDPATH**/ ?>