        ...
        <div>
            ...
            <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34]">
               ...
               <!-- Banner -->
                ...
                <div class="z-10 p-2" x-data="{ titel: '' }">
                    <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                        <div class="w-full">
                            ...
                            <input required min="2" type="text" class="w-full bg-[#f1e1c6] p-4 text-black rounded-lg"
                                x-model="titel" wire:model="title" placeholder="أدخل إسم القصيدة">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/5e8bc6c0e5464b06fcd977dd8f5e5140.blade.php ENDPATH**/ ?>