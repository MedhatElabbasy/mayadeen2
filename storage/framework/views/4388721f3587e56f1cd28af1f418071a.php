...
<div id="app">
    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                <div class="essential_audio" data-url="<?php echo e(asset("storage/".$this->writer->podcast)); ?>"></div>
            ...
            <div class="flex justify-between mt-12">
                <div>
                    <a wire:ignore href="<?php echo e(url('/writers/'.$writer->id.'/quote')); ?>" wire:navigate class="flex gap-2 justify-center items-start">
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/8123f03b8adf5663426b70082456b85f.blade.php ENDPATH**/ ?>