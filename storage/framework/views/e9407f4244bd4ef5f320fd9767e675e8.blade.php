                    ...
                    <form wire:submit="submit">
                        <div class="z-10 p-2" x-data="{rating_screen: 1}">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                <div x-show="rating_screen==|---LINE:592---|{{loop->index+1}}">
                                    |---LINE:593---|@foreach($rating_list['screen1'] as $rating)
                                        <div>
                                            <label for="rating"
                                                class="block font-medium text-[#f1e1c6] rounded-lg">|---LINE:596---|{{$rating}}</label>
                                            <div class="flex items-center text-center w-full ">
                                                |---LINE:598---|@foreach ([1, 2, 3, 4, 5] as $value)
                                                    <div class="contents cursor-pointer text-gray-300">
                                                        <div class="w-12 md:w-full">
                                                            <svg
                                                                wire:click="updateRating('|---LINE:602---|{{Str::slug($rating, '_')."',".$value}})"
                                                                x-on:click="|---LINE:603---|{{Str::slug($rating, '_')}}=|---LINE:603---|{{$value}}"
                                                                :class="{ 'text-yellow-300': |---LINE:604---|{{Str::slug($rating, '_')}} >= |---LINE:604---|{{$value}} }"
                ...
                <div class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                    <div class="z-10">
                        ...
                        <div class="beep text-center relative hover:scale-95 mb-8">
                            <a href="|---LINE:648---|{{ url('/surveys') }}" wire:navigate>
                                <img class="h-16 md:h-24 w-full" src="|---LINE:649---|{{ asset('website/images/button.svg') }}"
                                    alt="">
                                <span
