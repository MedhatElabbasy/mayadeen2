...
?>
                ...
                <div x-data="{ currentDate: 0 }">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div x-data="{
                            ...
                            <p <?php if($item->is_break): ?> class="py-4 bg-[#f4ceb0]" <?php else: ?> class="border-2 border-black px-2 py-4" <?php endif; ?>>
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/ff2dccd5d1eab61ecda026e77eccfe65.blade.php ENDPATH**/ ?>