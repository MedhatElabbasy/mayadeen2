               ...
               <!-- Banner -->
                ...
                <div class="z-10 p-2" x-data="{ name: '' }">
                    <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                        <div class="w-full">
                            <label for="story_title" class="block mb-2 font-medium text-[#f1e1c6]">إسم القصيدة</label>
                            <input required min="2" type="text" class="w-full bg-[#f1e1c6] p-4 text-black rounded-lg"
                                x-model="story_title" wire:model="title" placeholder="أدخل إسم القصيدة">
                                <div x-show="story_title.length < 2" class="text-white mt-2">
                    ...
                    x-on:click="if(story_title.length >= 2) step++">
                ...
                <div class="z-10 p-2" x-data="{ content: '' }">
                    <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                        <div class="w-full">
                            <label for="content" class="block mb-2 font-medium text-[#f1e1c6]">القصيدة</label>
                            <textarea class="w-full p-4" rows="6" required min="12" type="name" class="bg-[#f1e1c6] p-4 text-black rounded-lg"
                                x-model="content" wire:model="content">أدخل القصة</textarea>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/44356c9d2b37f60d5cee7ae99e468515.blade.php ENDPATH**/ ?>