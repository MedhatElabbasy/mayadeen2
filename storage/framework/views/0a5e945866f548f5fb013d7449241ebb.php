    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col md:flex-row md:justify-between" x-data="{ audio: true }">
                ...
                <img src="<?php echo e(asset("storage/".$this->writer->qr)); ?>" class="w-20 md:w-64">
            </div>
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/6c6671e578bbdea671618a10c5db28b4.blade.php ENDPATH**/ ?>