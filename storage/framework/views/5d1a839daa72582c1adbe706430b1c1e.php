        ...
        <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34] mb-4">
            ...
            <div>
                <div x-show="step == 1" class="px-8 border-x-2 border-[#e34e34]">
                    ...
                    <div class="text-center bg-[white] text-[#e34e34] p-4">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/c2cf39a4111ab4939ab4db5251711ed6.blade.php ENDPATH**/ ?>