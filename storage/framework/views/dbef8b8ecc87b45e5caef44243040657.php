            ...
            <div>
                <div x-show="step == 1" class="px-8 border-x-2 border-[#e34e34]">
                    ...
                    <div class="text-center p-4 my-4" style="line-height:normal">
                        <h1 class="text-center text-2xl font-bold mt-2 text-[#e34e34]">شروط المشاركة بالقصائد:</h1>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/a502bcce20af40f119ff0fc5144970d1.blade.php ENDPATH**/ ?>