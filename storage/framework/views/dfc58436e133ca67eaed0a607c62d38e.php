    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <audio src="<?php echo e(asset("storage/".$this->writer->podcast)); ?>">
...
Calamansi.autoload();
    ...
    ?>
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/332f4dea77c76342e108806ccdb03a1a.blade.php ENDPATH**/ ?>