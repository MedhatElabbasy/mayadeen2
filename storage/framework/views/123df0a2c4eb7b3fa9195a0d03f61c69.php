...
<div id="app">
    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col md:flex-row justify-center text-center md:justify-between">
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/527979a465a3b061b0cd5ca6ca094795.blade.php ENDPATH**/ ?>