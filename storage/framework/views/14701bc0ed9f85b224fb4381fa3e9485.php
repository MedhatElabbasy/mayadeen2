    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col md:flex-row md:justify-between" x-data="{ audio: true }">
                <img x-show="audio" x-on:click="audio==true" src="<?php echo e(asset('website/images/sound-play.svg')); ?>" class="w-14 cursor-pointer">
                <img x-show="!audio" x-on:click="audio==false" src="<?php echo e(asset('website/images/sound-stop.svg')); ?>" class="w-14 cursor-pointer">
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/733a0620e73eef74be9791bd9fccbc56.blade.php ENDPATH**/ ?>