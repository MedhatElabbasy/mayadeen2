...
<div id="app">
    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            -->
            <div class="flex flex-col md:flex-row md:justify-start" x-data="{ audio: true }">
                <img
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/8149dfe6622a3de745198597b55abd01.blade.php ENDPATH**/ ?>