    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <audio controls class="mb-4 bg-gray-200 shadow px-4 py-2 ">
...
Calamansi.autoload();
    ...
    ?>
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/fe7e2c0e03d932797aeeea29d9a38b6f.blade.php ENDPATH**/ ?>