    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center" wire:ignore>
                <div wire:ignore class="essential_audio" data-url="<?php echo e(asset("storage/".$this->writer->podcast)); ?>"></div>
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/36fe72685414d7fb83066acd6b42f64f.blade.php ENDPATH**/ ?>