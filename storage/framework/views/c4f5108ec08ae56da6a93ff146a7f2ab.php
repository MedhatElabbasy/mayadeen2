               ...
               <!-- Banner -->
                ...
                <div class="z-10 p-2" x-data="{ name: '' }">
                    <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                        <div class="w-full">
                            <label for="title" class="block mb-2 font-medium text-[#f1e1c6]">إسم القصيدة</label>
                            <input required min="2" type="text" class="w-full bg-[#f1e1c6] p-4 text-black rounded-lg"
                                x-model="story_title" wire:model="story_title" placeholder="أدخل إسم القصيدة">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/5fa9bdd70c0b5c3aa143cde8c46fe1e2.blade.php ENDPATH**/ ?>