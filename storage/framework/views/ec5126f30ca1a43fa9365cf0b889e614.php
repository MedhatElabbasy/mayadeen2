...
?>
            ...
            <div x-show="step==10">
                ...
                <div x-data="{
                    ...
                    <form wire:submit="submit">
                        <div class="z-10 p-2">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2" x-data="{rating_screen: 1}">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rating_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div x-show="rating_screen==<?php echo e($loop->index+1); ?>">
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/304a94546870ec427a65f8965d2fcbc1.blade.php ENDPATH**/ ?>