...
?>
                ...
                <div x-data="{ currentDate: 0 }">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->dates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div x-data="{
                            ...
                            <p <?php if($item->is_break): ?> class="border-2 border-black px-2 py-4 bg-[#f4ceb0]" <?php else: ?> class="border-2 border-black px-2 py-4" <?php endif; ?>>
                                <?php echo e(!$item->is_break ? $item->details : ''); ?>
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/16d8efe93d657bbf41fd28ea371a79bc.blade.php ENDPATH**/ ?>