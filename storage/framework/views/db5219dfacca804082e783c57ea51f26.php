...
?>
                            ...
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2" x-data="{rating_screen: 1}">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rating_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating_screens): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div x-show="rating_screen==<?php echo e($loop->index++); ?>">
                                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $rating_list["screen".$loop->index++]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div>
                                                <label for="rating"
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/1f4c0782ddd4de0da3d7c538ef8cb884.blade.php ENDPATH**/ ?>