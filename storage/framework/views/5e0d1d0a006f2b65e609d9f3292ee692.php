...
<div id="app">
    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col justify-center items-center">
                <div id="essential_audio" class="essential_audio" data-url="<?php echo e(asset("storage/".$this->writer->podcast)); ?>"></div>
        ...
        <?php
        $__scriptKey = '3319168838-0';
        ob_start();
    ?>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            Essential_Audio.Play("essential_audio");
        });
    </script>
        <?php
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/fc831c6ac0495a551ffa023014583fe6.blade.php ENDPATH**/ ?>