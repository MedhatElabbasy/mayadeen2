    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <div class="flex flex-col md:flex-row md:justify-between" x-date="{ audio: false }">
                <img x-show="audio==true" src="<?php echo e(asset('website/images/sound-play.svg')); ?>" class="w-14 cursor-pointer">
                <img x-show="audio==false" src="<?php echo e(asset('website/images/sound-stop.svg')); ?>" class="w-14 cursor-pointer">
...
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/246f1fdfff0286c2609c5d36cd3b0849.blade.php ENDPATH**/ ?>