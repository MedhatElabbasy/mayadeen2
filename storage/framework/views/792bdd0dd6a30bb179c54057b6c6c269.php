                    ...
                    <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                        <div class="w-full">
                            ...
                            <input required min="2" type="text" class="w-full bg-[#f1e1c6] p-4 text-black rounded-lg"
                                x-model="name" wire:model="title" placeholder="أدخل إسم القصيدة">
                                <div x-show="name.length < 2" class="text-white mt-2">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/44d2bea676b43cb7a2d205b6a3d4a005.blade.php ENDPATH**/ ?>