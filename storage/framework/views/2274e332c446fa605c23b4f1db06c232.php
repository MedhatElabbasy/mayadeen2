    ...
    <div class="flex flex-col justify-center items-center p-8">
        ...
        <div class="bg-[#f2e7d1] mt-8 rounded-3xl p-8 text-center justify-center items-center w-12/12 md:w-8/12">
            ...
            <p class="font-semibold mt-2">
                (
                <span><?php echo e(Carbon\Carbon::parse($this->writer->birthday)->translatedFormat('Y')); ?></span>
                /
                <span><?php echo e((Carbon\Carbon::parse($this->writer->deathday) > Carbon\Carbon::parse($this->writer->birthday)) ? 'الآن' : Carbon\Carbon::parse($this->writer->deathday)->translatedFormat('d F Y')); ?></span>
                )
            </p>
...
Calamansi.autoload();
    ...
    ?>
<?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/958d5568ba37db6e562af926d2dcf260.blade.php ENDPATH**/ ?>