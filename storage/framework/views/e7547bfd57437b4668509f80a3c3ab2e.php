        ...
        <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34] mb-4">
            ...
            <div>
                <div x-show="step == 1" class="px-8 border-x-2 border-[#e34e34]">
                    ...
                    <div class="text-center bg-[#e34e34] p-4 rounded-lg">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/d2063d2cead0a6dbcf8ebd58b02decc7.blade.php ENDPATH**/ ?>