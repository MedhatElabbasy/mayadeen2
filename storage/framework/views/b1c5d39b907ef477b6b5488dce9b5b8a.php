        ...
        <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34] mb-4">
            ...
            <div>
                <div x-show="step == 1" class="px-8 border-x-2 border-[#e34e34]">
                    ...
                    <div class="text-center p-4" style="line-height:normal">
                        <h1 class="text-center text-2xl md:text-6xl font-bold my-8 text-[#e34e34]">الشروط</h1>
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    ?>
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/a5958993abd0f9969ccb713aa812c24e.blade.php ENDPATH**/ ?>