...
?>
        ...
        <div id="app" x-data="{ step: 10 }" class="border-x-2 border-[#e34e34]">
            ...
            <div x-show="step==10">
                ...
                |---LINE:575---|@endphp
                <div x-data="{
                    |---LINE:577---|@foreach ($rating_full_list as $rating)
                        |---LINE:578---|{{ Str::slug($rating, '_').':1,' }}
                    |---LINE:579---|@endforeach
                }"
                    ...
                    <form wire:submit="submit">
                        |---LINE:590---|@foreach($rating_list as $rating_screens)
                        |---LINE:591---|@foreach($rating_list["screen".$loop->index++] as $rating)
                        <div class="z-10 p-2">
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2" x-data="{rating_screen: 1}">
                                    <div x-show="rating_screen==|---LINE:594---|{{$loop->index++}}">
                                            <div>
                                                <label for="rating"
                                                    class="block font-medium text-[#f1e1c6] rounded-lg">|---LINE:597---|{{$rating}}</label>
                                                <div class="flex items-center text-center w-full ">
                                                    |---LINE:599---|@foreach ([1, 2, 3, 4, 5] as $value)
                                                        <div class="contents cursor-pointer text-gray-300">
                                                            <div class="w-12 md:w-full">
                                                                <svg
                                                                    wire:click="updateRating('|---LINE:603---|{{Str::slug($rating, '_')."',".$value}})"
                                                                    x-on:click="|---LINE:604---|{{Str::slug($rating, '_')}}=|---LINE:604---|{{$value}}"
                                                                    :class="{ 'text-yellow-300': |---LINE:605---|{{Str::slug($rating, '_')}} >= |---LINE:605---|{{$value}} }"
                                ...
                                |---LINE:618---|{{-- <div class="max-w-sm mx-auto">
                             ...
                             <div class="beep text-center relative hover:scale-95 mt-4 rounded-lg">
                                <img class="h-16 md:h-24 w-full" src="|---LINE:629---|{{ asset('website/images/button.svg') }}"
                                    alt="">
                                <button
                                    x-on:click="    "
                                    type="button"
                ...
                <div class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                    <div class="z-10">
                        ...
                        <div class="beep text-center relative hover:scale-95 mb-8">
                            <a href="|---LINE:650---|{{ url('/surveys') }}" wire:navigate>
                                <img class="h-16 md:h-24 w-full" src="|---LINE:651---|{{ asset('website/images/button.svg') }}"
                                    alt="">
                                <span
