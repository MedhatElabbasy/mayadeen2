                                ...
                                <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <input required type="email" class="bg-[#f1e1c6] p-2.5 text-black rounded-lg w-full"
                                            wire:model="w1_email" placeholder="أدخل البريد الإلكتروني">
...
unset($__errorArgs, $__bag); ?> <!--[if ENDBLOCK]><![endif]-->
    ...
    <?php /**PATH E:\xampp\htdocs\mayadeen2\storage\framework\views/60cae256c11aa3d76dfa428462b3901d.blade.php ENDPATH**/ ?>