    ...
    @volt
        <div id="app" x-data="{ step: 1 }" class="border-x-2 border-[#e34e34]">
            ...
            <div x-show="step==2" class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                <div class="z-10">
                    <h1 class="text-center text-3xl mt-16 font-bold my-8 text-[#e34e34]">ما مدى رضاك عن مرافق المهرجان ؟</h1>

                    <ul class="grid w-full grid-cols-4 text-center">
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            <input type="radio" id="facilities_radio1" value="verySatisfied" selected class="hidden peer"
                                required>
            ...
            <div x-show="step==3" class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                <div class="z-10">
                    ...
                    <ul class="grid w-full grid-cols-4 text-center">
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            <input type="radio" id="organization_radio1" value="verySatisfied" selected class="hidden peer"
                                required>
                            <label for="organization_radio1" wire:click="updateOrganization('verySatisfied')"
                                x-on:click="step++">
                                <div class="text-center relative mt-16">
                                    <div class="flex flex-col gap-2 items-center justify-center cursor-pointer">
                                        <img src="{{ asset('website/images/rating/1.svg') }}" class="drop-shadow-sm">
                        ...
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            ...
                            <label for="organization_radio2" wire:click="updateOrganization('satisfied')"
                                x-on:click="step++">
                                <div class="text-center relative mt-16">
                                    <div class="flex flex-col gap-2 items-center justify-center cursor-pointer">
                                        <img src="{{ asset('website/images/rating/2.svg') }}" class="drop-shadow-sm">
            ...
            <div x-show="step==4" class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                <div class="z-10">
                    ...
                    <ul class="grid w-full grid-cols-4 text-center">
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            <input type="radio" id="events_radio1" value="verySatisfied" selected class="hidden peer"
                                required>
            ...
            <div x-show="step==5" class="flex flex-col items-center justify-center animate__animated animate__backInDown">
                <div class="z-10">
                    ...
                    <ul class="grid w-full grid-cols-4 text-center">
                        <li class="beep hover:drop-shadow-lg hover:scale-125 hover:-mt-8">
                            <input type="radio" id="access_radio1" value="verySatisfied" selected class="hidden peer"
                                required>
            ...
            @if (!$this->completed)
                <div x-data="{ rating: 5 }" x-show="step==6"
                            ...
                            <div class="bg-[#e34e34] py-4 px-4 rounded-lg flex flex-col gap-2">
                                <div class="max-w-sm mx-auto pt-2">
                                    ...
                                    <input required min="2" type="name"
                                        class="bg-[#f1e1c6] p-2.5 text-black rounded-lg" wire:model="name"
                                ...
                                {{-- <div class="max-w-sm mx-auto w-full">
                                    ...
                                    <div class="flex items-center text-center">
                                        @foreach ([1, 2, 3, 4, 5] as $rating)
                                            <div class="contents cursor-pointer scale-90"
                                                wire:click="updateRating({{ $rating }})">
                                                <svg x-on:click="rating={{ $rating }}"
                                                    :class="['text-yellow-300', rating < {{ $rating }} ?
                                                        'text-gray-300' : ''
                                                    ]"
