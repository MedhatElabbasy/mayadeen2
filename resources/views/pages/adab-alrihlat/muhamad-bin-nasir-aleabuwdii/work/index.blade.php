    ...
    <div class="container authors-container mt-5 p-4">
      <div class="row">
        <div class="text-foot text-center">
          ...
          <p class="fw-bold fs-2">محمد العبودي فى الرحلات</p>
        </div>
        <ul class="text-des fw500 px-5" dir="rtl">
          <li>في جنوب الهند</li>
          <li>رحلات فى أمريكا الوسطى (المكسيك/بنما/كوستاريكا)</li>
          <li>في شرق البرازيل</li>
          <li>نظرة إلى..الوجه الآخر من الأرض</li>
          <li>من روسيا البيضاء إلى روسيا الحمراء</li>
          <li>جولة خاطفة فى جمهورية الجبل الأسود </li>
          <li> رحلات .. فى جمهوريات الموز (هندوراس/نيكارقوا/كوستاريكا).</li>
          <li>على أرض القهوة العربية</li>
        </ul>
        ...
        >
          ...
          <div
            class="img-routing-container d-flex align-items-center gap-2"
            onclick="window.location.href='{{url('/adab-alrihlat/muhamad-bin-nasir-aleabuwdii/map')}}' "
          >
