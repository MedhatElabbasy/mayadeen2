        ...
        ">
            ...
            <div style="text-align: center">
                ...
                <div style="margin-top:12px">
                    {!! nl2br(str_replace(',', ' ', htmlspecialchars($content, ENT_QUOTES))) !!}
                <div>
            </div>
                ...
                <table style="border-width: 2px; border-color: #000000; width: 100%; font-size: 0.875rem; line-height: 1.25rem; text-align: right; color: #000000;">
                   <thead style="font-size: 0.875rem; line-height: 1.25rem; text-align: center; color: #000000; background: #f4ceb0;">
                    ...
                    <tr style="font-size: 0.875rem; line-height: 1.25rem; text-align: center; color: #000000; background: #f1e1c6;">
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w1_email }}</td>
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w1_name }}</td>
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w1_name }} </td>
                    </tr>
                    <tr style="font-size: 0.875rem; line-height: 1.25rem; text-align: center; color: #000000; background: #f1e1c6;">
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w2_email }}</td>
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w2_number }}</td>
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w2_name }} </td>
                    </tr>
                    <tr style="font-size: 0.875rem; line-height: 1.25rem; text-align: center; color: #000000; background: #f1e1c6;">
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w3_email }}</td>
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w3_number }}</td>
                        <td style="padding: 0.5rem; border-width: 2px; border-color: #000000; background: #f4ceb0;">{{ $w3_name }} </td>
                    </tr>
                </table>
            </div>
        </div>
